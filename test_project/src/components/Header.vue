        ...
        <div>
            <div class="header">
                <div class="header_block">
                    <span>shop</span>
                    <router-link to="#">
                        <svg class="header_block_svg" width="39" height="34" viewBox="0 0 39 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="header_block">
                    ...
                    <a class="header_block_basket" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                        ...
                        <img class="header_block_basket_ellipse" src="../assets/img/ellipse.png" alt="logo basket">
                        <span class="header_block_basket_counter">{{ counter }}</span>
                    </a>
                </div>
            </div>

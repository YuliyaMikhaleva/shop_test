            ...
            <div :class="$style.header">
                <div :class="$style.header__wrp">
                    ...
                    <div :class="$style.header__block">
                        ...
                        <HeaderButtons :class="$style.header__links"/>

                        <!--
                            @review
                            В случаях, когда у нас кликабельный элемент, но он никуда не ведет (не ссылка)
                            не нужно его делать ссылкой. Для этого есть button. Не супер серьезная вещь, но со стороны семантики правильнее
                         -->
                        <a href="#" :class="$style.header__buttonBasket" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                            <svg :class="$style.header__buttonSvg" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <img :class="$style.header__ellipseCounter" src="../../assets/img/ellipse.png" alt="logo basket">
                            <span :class="$style.header__counter">{{ counter.length }}</span>
                        </a>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters('basketModule',{counter: 'getBasket'}),
            /**

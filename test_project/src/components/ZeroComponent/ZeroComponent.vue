<!--Компонент пустой страницы, если товаров в каталоге нет-->
<template>
    <section :class="$style['zero-page']">
        <svg :class="$style['zero-page__svg']" width="99" height="99" viewBox="0 0 99 99" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span :class="$style['zero-page__txt']">В данной категории товаров пока нет</span>
    </section>
</template>

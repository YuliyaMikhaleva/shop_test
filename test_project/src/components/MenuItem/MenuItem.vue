...
<!--
    @review
    Не стоит дублировать пустые обертки, можно было вывести напрямую router-link.
    Так же, когда вешаем события, свойственные кнопке (клик, например). Нужно делать элемент кнопкой
    (или ссылкой, в зависимости от ситуации). Это намного правильнее со стороны семантики, тк например

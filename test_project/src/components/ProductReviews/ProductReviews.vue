        ...
        <article :class="$style.review" v-bind:key="review.author" v-for="review of reviews" v-bind:review="review">
            ...
            <div :class="$style.review__block">
                <div :class="$style.review__header">
                    ...
                    <div>
                            <span :key="'custom_component-'+index" v-for="index of review.rate">
                        ...
                        <span :key="index" v-for="index of (5-review.rate)">
                                <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p :class="$style.review__txt">{{review.text}}</p>
            </div>
        </article>
    </section>
</template>
